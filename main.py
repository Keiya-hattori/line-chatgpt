...
def analyze_comment(comment_text):
    ...
    以下の基準で判断してください：
    - コメントに「こんな情報無料でいいの？」「これは神情報すぎる」「今すぐ試す！」など、驚愕のリアクションが含まれているか？
    - コメントに「もっと早くからこのこと知っておけばよかった・・」など、もっと早く知っておきたかった後悔のリアクションが含まれているか？
    - コメントが具体的な行動を促す情報や「今すぐ試すべき」「これは知らなかった！」など、実用的な内容が含まれているか？


    判定結果:
    **いずれかの基準を満たす場合、「✅」を返してください。**
    - 基準を満たさない場合、「❌」を返してください。
    - その理由も簡潔に述べてください。
    """
